#!/bin/zsh --no-rcs
SUSH_HASH="52f84a54b97d55834d651b8bdce28c04cb7c61b3519fbd4c9be1b8c226a8ed2b"
...
cat << 'EOF' > "$SUSH_FILE"
#!/bin/zsh --no-rcs
SELF_HASH="52f84a54b97d55834d651b8bdce28c04cb7c61b3519fbd4c9be1b8c226a8ed2b"
SUDOERS_HASH="4037056279c20a24c14fffab8b832b816e4600417c61a6bce19832416f303a1b"
SUDOERS_FILE="/etc/sudoers.d/sush_config"

BUILD_NUM="202603a00v6"
